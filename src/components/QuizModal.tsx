...
const QUESTIONS: Question[] = [
  {
    ...
    badge: "Paixão",
    options: [
      { label: "Flamengo", value: "fla", icon: <img src="/src/assets/escudos/Flamengo.png" alt="Flamengo" className="size-8 object-contain" /> },
      { label: "Corinthians", value: "cor", icon: <img src="/src/assets/escudos/Corinthians.png" alt="Corinthians" className="size-8 object-contain" /> },
      { label: "Palmeiras", value: "pal", icon: <img src="/src/assets/escudos/Palmeiras.png" alt="Palmeiras" className="size-8 object-contain" /> },
      { label: "Santos", value: "san", icon: <img src="/src/assets/escudos/Santos.png" alt="Santos" className="size-8 object-contain" /> },
      { label: "São Paulo", value: "sao", icon: <img src="/src/assets/escudos/SaoPaulo.png" alt="São Paulo" className="size-8 object-contain" /> },
